...
A fun little challenge was calculating the total and handling click events. I utilized the .reduce() method to dynamically sum the amounts, and implemented event delegation on the parent list to handle the delete buttons efficiently without attaching a listener to every single item!

<h2><a class="anchor" id="key-insights"></a>Key Insights</h2>

I realized how powerful array methods like .reduce() are; calculating dynamic totals became incredibly clean and straightforward.
